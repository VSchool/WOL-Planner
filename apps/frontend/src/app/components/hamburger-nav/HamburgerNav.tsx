    ...
    return (
        <div className="nav" onClick= {() => toggleSideBar()}>
            <div className="nav-container">
                <div id="FlyoutMenu-bg" className="opaque-container"></div>
                    <div id="FlyoutMenuRoot" className="fly-out-menu-root">
                        <div className="trademark-container">
                            <div id="W" className="trademark-letter">W</div>
                            <img
                                src={lineList}
                                alt="lineList"
                                id="lineList"
                                className="trademark-symbol"
                            />
                            <div id="L" className="trademark-letter">L</div>
