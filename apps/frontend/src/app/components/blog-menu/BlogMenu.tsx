...
const resources = [
  { name: 'Help center', description: 'Get all of your questions answered', href: '#', icon: "" },
  { name: 'Guides', description: 'Learn how to maximize our platform', href: '#', icon: "" },
  { name: 'Events', description: 'See meet-ups and other events near you', href: '#', icon: "" },
]
// Original w/ icons
// const resources = [
